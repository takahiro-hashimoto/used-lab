        ...
        <div className="l-grid l-grid--1col" style={{ gap: 'var(--space-xl)' }}>
                ...
                <div className="m-timeline__item">
                  ...
                  <div className="m-timeline__content">
                    ...
                    <div className="m-callout m-callout--tip" style={{ marginTop: 'var(--space-xl)' }}>
                      <span className="m-callout__label">注意点</span>
          ...
          <div id="amazon" className="m-card m-card--shadow buy-method-card">
            ...
            <div className="buy-method-card__body">
              ...
              <div className="buy-method-card__text">
                <p>AmazonでiPadを購入する方法は下記のようなメリット・デメリットがあります。</p>
                <p>ポイント還元が受けられたり、iPadがセール対象になるのに加えて、正規代理店ならではのメリットがいくつもあるのが特徴です。</p>
              ...
              <div className="buy-method-card__sub">
                ...
                <div className="buy-method-card__text">
                  <p>Amazonでは年に4回ほど大きなセールが実施されており、iPadシリーズが頻繁にセール対象品として登場します。</p>
                  <p>また、大型セール以外にも月末に実施されるタイムセール祭が行われており、ここでもiPadがセール対象になる場合があるので要チェックです。</p>
                </div>
          ...
          <div id="rakuten" className="m-card m-card--shadow buy-method-card">
            ...
            <div className="buy-method-card__body">
              ...
              <div className="buy-method-card__text">
                <p>楽天市場でiPadを購入する方法は下記のようなメリット・デメリットがあります。</p>
                <p>楽天経済圏に属している方はポイントアップイベント時の還元率に期待が持てます。</p>
                <p>ただし楽天市場に出品されているiPadは正規代理店の製品ではないので、定価よりも価格が高い場合があり、公式サイトとの比較が必須です。</p>
              </div>
              ...
              <div className="buy-method-card__sub">
                ...
                <a href="https://hb.afl.rakuten.co.jp/hgc/146d79d6.e1ce9058.146d79d7.d4b077e7/?pc=https%3A%2F%2Fsearch.rakuten.co.jp%2Fsearch%2Fmall%2Fipad%2F&amp;link_type=hybrid_url&amp;ut=eyJwYWdlIjoidXJsIiwidHlwZSI6Imh5YnJpZF91cmwiLCJjb2wiOjF9" className="buy-method-cta" target="_blank" rel="nofollow noopener noreferrer">
                  <i className="fa-solid fa-cart-shopping" aria-hidden="true"></i> 楽天市場でiPadを購入する
                </a>
              </div>
            </div>
          </div>
          ...
          <div id="yahoo" className="m-card m-card--shadow buy-method-card">
            ...
            <div className="buy-method-card__body">
              ...
              <div className="buy-method-card__text">
                <p>ヤフーショッピングでApple製品を購入する方法は下記のようなメリット・デメリットがあります。</p>
                <p>ヤフー経済圏に属している方はポイントアップイベント時の還元率に期待が持てます。</p>
                <p>ただしヤフーショッピングに出品されているiPadは正規代理店の製品ではないので、定価よりも価格が高い場合があり、公式サイトとの比較が必須です。</p>
              </div>
          ...
          <div id="used" className="m-card m-card--shadow buy-method-card">
            ...
            <div className="buy-method-card__body">
              ...
              <div className="buy-method-card__text">
                <p>新品にこだわらないなら中古iPadを購入するというのも1つの選択肢です。</p>
                <p>中古であれば確実に安くiPadを購入することができますし、最新モデルは自分にとってオーバースペックという場合に型落ち品を柔軟に選べるのも良い点です。</p>
              </div>

              <div className="merit-demerit">
                <div className="merit-box">
                  <p className="merit-box__title"><i className="fa-regular fa-circle-check" aria-hidden="true"></i> iPadを中古で買うメリット</p>
                  <ul>
                ...
                <div className="demerit-box">
                  <p className="demerit-box__title"><i className="fa-regular fa-circle-xmark" aria-hidden="true"></i> iPadを中古で買うデメリット</p>
                  <ul>
                    <li>希望スペックの商品がない可能性がある</li>
            ...
            <div className="buy-method-card__body">
              ...
              <div className="buy-method-card__sub">
                ...
                <div className="buy-method-card__text">
                  ...
                  <p>在庫は不安定で希望のiPadに出会えるかは運次第ですが、新品同様の品質が割安で手に入るので、購入前に一度<a href="https://www.apple.com/jp/shop/refurbished/ipad" target="_blank" rel="nofollow noopener noreferrer">Apple整備済製品ストア</a>をチェックしてみる価値があります。</p>
                </div>
              </div>
              ...
              <div className="buy-method-card__sub">
                ...
                <div className="buy-method-card__text">
                  <p>Appleストアでは<a href="https://www.apple.com/jp/shop/browse/financing" target="_blank" rel="nofollow noopener noreferrer">金利0%・最大24回払いのショッピングローン</a>が利用できます。高価で手が出しづらいiPad ProやiPad Airでも、月々の負担を抑えて購入できるのは大きなメリットです。</p>
              ...
              <div className="buy-method-card__sub">
                <h4>学生・教職員向け割引がある</h4>
                <div className="buy-method-card__text">
                  <p>大学・高等専門学校・専門学校の学生や教職員であれば、iPadを約10%OFFで購入できる<a href="https://www.apple.com/jp-edu/store" target="_blank" rel="nofollow noopener noreferrer">学生・教職員向けストア</a>が利用できます。対象者は限られますが、条件に当てはまるならぜひ活用しましょう。</p>
