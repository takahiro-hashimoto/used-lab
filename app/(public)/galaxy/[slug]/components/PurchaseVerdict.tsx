...
import { getGalaxyVerdict } from '../lib/helpers'
...
export default function PurchaseVerdict({ model, latestPrice, allModels }: Props) {
  ...
  return (
    <ModelPurchaseVerdict
      ...
      topRatings={[
        ...
        { icon: 'fa-solid fa-code-branch', label: 'サポート推定', value: `残り${v.remainingYears}年` },
