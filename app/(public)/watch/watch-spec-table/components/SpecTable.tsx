    ...
    <section className="l-section" id="spec-table" aria-labelledby="heading-spec-table">
      <div className="l-container">
        ...
        <p style={{ marginTop: '1rem', fontSize: '0.75rem', color: '#888', lineHeight: 1.7 }}>
          ※ 中古相場は、イオシス・ゲオ・じゃんぱらの3店舗から毎日自動取得した最安値・最高値の平均中間値です。対象は各機種の最小容量モデルで、100円単位に丸めて表示しています。機種別の価格推移グラフは「<Link href="/watch/watch-price-info/" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>Apple Watch中古相場・価格推移ページ</Link>」でご確認いただけます。
        </p>
