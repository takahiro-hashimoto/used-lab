    ...
    <section className="l-section" id="compare" aria-labelledby="heading-compare">
      <div className="l-container">
                ...
                <tr>
                  ...
                  {items.map(({ model }) => (
                    <th key={model.id} scope="col">
                      <strong>{model.shortname || model.model}</strong>
                    </th>
                  ))}
                </tr>
              </thead>
                  ...
                  {items.map(({ model }) => (
                    <td key={model.id}>
                      {model.image ? (
                        ...
                        <Image
                          src="https://placehold.co/60x80/f5f5f7/1d1d1f?text=Mac"
                          alt={model.model}
                          width={60}
                          height={80}
                          loading="lazy"
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg related-links">
          <Link href="/macbook/macbook-spec-table/" className="m-card m-card--shadow related-link-card">
          ...
          <Link href="/macbook/used-macbook-support/" className="m-card m-card--shadow related-link-card">
          ...
          <Link href="/macbook/used-macbook-attention/" className="m-card m-card--shadow related-link-card">
            <span className="related-link-card__icon">
