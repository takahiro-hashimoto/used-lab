        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">フィットネスアプリで1日の活動量をチェック</h3>
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">ワークアウトで運動の記録を取る</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">睡眠アプリで睡眠の質をチェック</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">転倒検出 &amp; 緊急通報機能で万が一に備える</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">血中酸素濃度を測定する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">電気心拍センサーで心拍数をチェック</h3>
              <p className="media-card__desc">
