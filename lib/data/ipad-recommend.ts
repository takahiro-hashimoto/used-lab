...
export const RECOMMEND_META: Record<string, RecommendMeta> = {
  'normal-11': {
    ...
    description: [
      'できるだけ安くiPadを使いたいなら、iPad 第11世代が最適です。A16 Bionicチップを搭載し、前世代のA14から処理性能が大きく向上しました。動画視聴やWeb閲覧、SNSはもちろん、ちょっとした書類作成やオンライン授業にも余裕を持って対応できます。',
      ...
      '2025年発売のモデルなので、iPadOSサポートは2032年頃まで続く見込みです。前世代の第10世代は在庫がかなり少なくなっていて価格差も小さいため、いまから買うなら第11世代を選んでおくのが無難です。',
    ],
    good: [
      'とにかく安くiPadを手に入れたい',
      '動画視聴やWeb閲覧がメインの使い方',
  ...
  'mini-7': {
    ...
    description: [
      '持ち運びやすさを最優先するなら、iPad mini 第7世代が一押しです。8.3インチの小型ディスプレイながらA17 Proチップを搭載し、処理性能はiPhone 15 Proと同等。電子書籍リーダーとしてもゲーム機としても優秀です。',
  ...
  'air-6-11': {
    ...
    description: [
      ...
      'M3搭載の第7世代が登場したことで中古相場は下がりましたが、在庫は他の入門モデルほど多くありません。条件の良い個体を見つけたら早めに動くのがおすすめです。',
    ],
    good: [
      '動画編集やイラスト制作にも使いたい',
  ...
  'pro11-4': {
    ...
    description: [
      ...
      'M4搭載の後継モデルが登場したことで相場は下落しましたが、流通量は入門モデルに比べてかなり少なめです。12.9インチ 第6世代と同じM2チップを積みつつコンパクトに持ち運べる点が強みなので、見つけたときが買い時になりやすいモデルです。',
    ],
    good: [
  ...
  'pro12-6': {
    ...
    description: [
      ...
      'M4搭載のiPad Pro 13インチが登場したことで相場は下がりましたが、そのぶん中古市場での流通量も大きく減っています。日によっては在庫が見つからないこともあるため、探すときは複数のショップをこまめに確認してください。',
    ],
    good: [
      '大画面でイラストや動画編集をしたい',
