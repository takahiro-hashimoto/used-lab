    ...
    <div className="u-mt-2xl" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
      ...
      <div className="m-card m-card--shadow m-card--padded">
        ...
        <div className="media-card__body">
          ...
          <p className="media-card__desc">
            冒頭でも書いた通り、これまでは<Link prefetch={false} href="/ipad/ipad-mini-6-review/">iPad mini（第6世代）</Link>でモデリングを行ってきました。しかし8.3インチという画面サイズでは、モデリングソフトの使用中に一部のコマンドパネルが省略されてしまうなど、作業にストレスを感じる場面がありました。
          </p>
      ...
      <div className="m-card m-card--shadow m-card--padded">
        ...
        <div className="media-card__body">
          ...
          <p className="lead-link u-mt-sm">
            ...
            <Link prefetch={false} href="/ipad/ipad-spec-table/">歴代iPadのスペック比較表</Link>
          </p>
        </div>
      </div>
      ...
      <div className="m-card m-card--shadow m-card--padded">
        ...
        <div className="media-card__body">
          ...
          <p className="lead-link u-mt-sm">
            <i className="fa-solid fa-arrow-right" aria-hidden="true"></i>{' '}
            <Link prefetch={false} href="/ipad/apple-pencil-compare/">Apple Pencilの違いを比較！</Link>
          </p>
        </div>
      </div>
    </div>
