    ...
    <section className="l-section" id="criteria" aria-labelledby="heading-criteria">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-criteria">
          中古Samsung Galaxyの購入先を選ぶ6つのポイント
        </h2>
        <p className="m-section-desc">中古Galaxyは比較的高価な買い物です。端末の価格だけでなく、これから紹介する6つの項目もチェックしておきましょう。</p>
        ...
        <div className="l-grid l-grid--2col l-grid--gap-lg u-mt-xl">
          ...
          <IconCard icon="fa-solid fa-battery-half" title="バッテリー最大容量の記載">
            <p>中古Galaxyを買うなら、バッテリーの状態が確認できるショップを選ぶのが理想です。<strong>劣化が進むと体感で持ちが悪くなる</strong>ため、状態を見てから購入できると安心です。</p>
          ...
          <IconCard icon="fa-solid fa-camera" title="実物写真の有無">
            ...
            <p>ただし安さ重視でBランク以下の端末を買う場合は、<strong>傷の程度が写真で確認できるショップ</strong>を選ぶと安心です。折りたたみ（Z）は折り目やヒンジの状態も要チェックです。</p>
          </IconCard>

          <IconCard icon="fa-solid fa-truck" title="配送料込みの総額">
            <p>中古Galaxyを購入する際は端末価格に加えて配送料がかかります。ショップごとに配送料は異なりますし、一定額以上の購入で送料無料になる場合もあります。</p>
