...
const TIMING_CARDS: TimingCard[] = [
  {
    ...
    content: (
      <>
        <p>Apple Watchは発売から約5年が経過すると、最新のwatchOSアップデート対象から外れる可能性が非常に高くなります。iPhoneの約7年と比べるとサポート期間が短い点に注意が必要です。</p>
        <p>OSの更新が止まると、最新の健康管理機能やフィットネス機能が使えなくなるだけでなく、セキュリティリスクが高まるのもデメリット。</p>
