...
import { calculateOSLifespan, calculatePriceRange } from '@/lib/utils/ipad-helpers'
    ...
    <section className="l-section l-section--sm section-lead" aria-label="記事の導入">
      <div className="l-container">
        <div className="lead-box">
          <p>
            「中古の{model.model}って、今から買っても大丈夫？」この記事では、そんな疑問を解消するために中古価格の推移やベンチマーク、対応アクセサリーなど<strong>購入判断に必要な情報</strong>をまとめました。
          </p>
          <p>
            ...
            {osLife.isSupported
              ...
              : <>ただしiPadOSサポートは終了済みのため、セキュリティ面には注意が必要です。</>
            }
          </p>
          <p className="lead-link">
            <i className="fa-solid fa-arrow-right" aria-hidden="true"></i>{' '}
            機種選びから始めたい方は「<Link prefetch={false} href="/ipad/">中古iPad購入ガイド</Link>」もどうぞ。
          </p>
        </div>
      </div>
    </section>
