...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: PAGE_DESCRIPTION,
    url: '/iphone/mvno/',
    images: [{ url: getHeroImage('/iphone/mvno/'), width: 1200, height: 630, alt: PAGE_TITLE }],
  },
  twitter: {
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    images: [getHeroImage('/iphone/mvno/')],
  },
}
...
export default async function MvnoPage() {
  const [plans, allMvnoProviders] = await Promise.all([
    getMvnoPlans(),
    getMvnoProviders(),
  ])
        ...
        <section className="l-section l-section--sm section-lead" aria-label="記事の導入">
          <div className="l-container">
            <div className="lead-box">
              ...
              <p className="lead-link"><i className="fa-solid fa-arrow-right" aria-hidden="true"></i> 情報を網羅的に得たい方は「<Link prefetch={false} href="/iphone/">中古iPhoneおすすめ機種・選び方ガイド</Link>」も参考にしてみてください！</p>
            </div>
          </div>
        </section>
              ...
              <article key={db.provider_slug} className="m-card m-card--shadow recommend-card" id={db.provider_slug}>
                ...
                {providerPlans.length > 0 && (
                  <div className="recommend-card__price">
                    ...
                    <div className="recommend-card__price-grid m-scroll-x m-scroll-x--styled">
