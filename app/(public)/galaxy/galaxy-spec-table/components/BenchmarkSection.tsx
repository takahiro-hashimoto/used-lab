...
export default function BenchmarkSection({ models, avgPrices, shopLinks }: Props) {
  const [selectedModel, setSelectedModel] = useState<GalaxyModel | null>(null)
    ...
    <section className="l-section" id="benchmark" aria-labelledby="heading-benchmark">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-benchmark">
          歴代Samsung Galaxyのチップ性能・処理速度を比較（ベンチマークスコア）
        </h2>
        <p className="m-section-desc">
          Snapdragon（一部Exynos/Dimensity）の性能の違いを可視化するために2種類のベンチマークスコア一覧表を用意。
        </p>
        <p className="m-section-desc">
          Galaxyの買い替えでどれくらい処理速度が上がるのかご確認ください。
        </p>
            ...
            <div className="m-card m-card--shadow m-table-card">
              <div className="m-table-scroll">
                <table className="m-table m-table--sticky-col bench-table">
                  <caption className="visually-hidden">Galaxyモデル別 AnTuTu Benchmark v10 スコア比較</caption>
                  <thead>
                    <tr>
                      <th scope="col" className="bench-table__sticky">モデル</th>
                      <th scope="col">合計</th>
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">
            シリーズ別の性能比較や用途別おすすめスコアの目安は「<Link prefetch={false} href="/galaxy/benchmark/">歴代Samsung Galaxyベンチマーク比較ランキング</Link>」で詳しく解説しています。
          </p>
        </div>
      </div>
    </section>
