...
export const RECOMMEND_META: Record<string, RecommendMeta> = {
  'mtjv3ja': {
    ...
    description: [
      ...
      'USB-Cポート採用でiPhone 15以降やMacBookと充電ケーブルを統一できます。今回紹介する3機種の中では流通量がもっとも多く、状態や付属品を比べながら選べるのも強みです。',
    ],
    good: [
      '最高水準のノイズキャンセリングが欲しい',
      'カナル型のしっかりした装着感が好み',
  ...
  'mxp93ja': {
    ...
    description: [
      ...
      '2024年発売でファームウェアのサポートは2031年頃まで続く見込みです。ただし中古市場ではまだ球数が少なく、相場はAirPods Pro 2と同等かやや高い水準にあります。装着感を最優先するなら有力ですが、価格を重視するならPro 2と比べたうえで決めるのがおすすめです。',
    ],
    good: [
      'オープン型でノイキャンが欲しい',
      '長時間つけても疲れにくいモデルが欲しい',
  ...
  'mxp63ja': {
    ...
    description: [
      ...
      '3機種の中では中古相場がもっとも手ごろで、ANCモデルとは5,000円以上の差があります。ノイキャンは要らないという方にとって、いちばんコストパフォーマンスの高いAirPodsです。',
    ],
    good: [
      'AirPodsをまず試してみたい',
      'ノイキャン不要で音楽・通話がメイン',
