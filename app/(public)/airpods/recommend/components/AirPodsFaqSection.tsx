    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <ul>
            <li>発売から約7年がファームウェアサポートの目安です。2029年以降までサポートされるモデルを選びましょう。</li>
            <li>ノイズキャンセリング・空間オーディオ・防水性能・装着タイプ（カナル型/オープン型）など、使い方に合ったモデルを選びましょう。</li>
            <li>残りサポート期間と中古相場を比較し、コスパの良い機種を選びましょう。</li>
          </ul>
        </>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <ul>
            <li>AirPodsはバッテリー交換が難しいため、使用時間が極端に短くないか確認しましょう。</li>
            <li>充電ケースのバッテリーも劣化します。膨張や充電端子の損傷がないか確認しましょう。</li>
            <li>ショップの保証期間を確認しましょう。イオシスなら3ヶ月保証など、ショップによって異なります。</li>
            <li>充電端子がLightningかUSB-Cか確認しましょう。iPhone 15以降と統一するならUSB-Cモデルがおすすめです。</li>
          </ul>
        </>
      ),
    },
