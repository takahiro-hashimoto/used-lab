    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: sectionGap, marginTop: sectionGap }}>
      ...
      <div id="cooling">
        <div className="m-card m-card--shadow m-card--padded">
          <img src="/images/content/macbook-image-05.jpg" alt="冷却方式と持続性能" style={imgStyle} loading="lazy" />
      ...
      <div id="chip">
        <div className="m-card m-card--shadow m-card--padded">
          <img src="/images/content/macbook-image-01.jpg" alt="チップ性能の違い" style={imgStyle} loading="lazy" />
      ...
      <div id="display">
        <div className="m-card m-card--shadow m-card--padded">
          <img src="/images/content/use-macbook.jpg" alt="ディスプレイの違い" style={imgStyle} loading="lazy" />
      ...
      <div id="port">
        <div className="m-card m-card--shadow m-card--padded">
          <img src="/images/content/macbook-image-03.jpg" alt="ポート・拡張性の違い" style={imgStyle} loading="lazy" />
      ...
      <div id="external-display">
        <div className="m-card m-card--shadow m-card--padded">
          <img src="/images/content/macbook-image-04.jpg" alt="外部ディスプレイの接続台数" style={imgStyle} loading="lazy" />
      ...
      <div id="weight">
        <div className="m-card m-card--shadow m-card--padded">
          <img src="/images/content/macbook-image-06.jpg" alt="重量とバッテリーの違い" style={imgStyle} loading="lazy" />
