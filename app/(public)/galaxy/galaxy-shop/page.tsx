...
const PAGE_TITLE = `中古Samsung Galaxyを買うならどこ？ECサイト・ショップのおすすめを紹介【${SHOP_PAGE_DATE_LABEL}】`
const PAGE_DESCRIPTION = `中古Samsung Galaxyを買うならどこがおすすめ？信頼できるECサイト・ショップを保証・価格・品質の観点から徹底比較。最適な購入先を紹介します【${SHOP_PAGE_DATE_LABEL}】`
const PAGE_URL = 'https://used-lab.jp/galaxy/galaxy-shop/'

export const metadata: Metadata = {
  title: PAGE_TITLE,
  description: PAGE_DESCRIPTION,
  alternates: { canonical: '/galaxy/galaxy-shop/' },
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    url: '/galaxy/galaxy-shop/',
    images: [{ url: getHeroImage('/galaxy/galaxy-shop/'), width: 1200, height: 630, alt: PAGE_TITLE }],
  },
  twitter: {
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    images: [getHeroImage('/galaxy/galaxy-shop/')],
  },
}

export default async function GalaxyShopPage() {
  const shops = await getShops()

  // 比較表用: url が存在し、かつ apple（Apple整備済＝Galaxy非対応）を除外したショップを抽出
  ...
  const { dateStr, dateDisplay } = getGitDateForFile('app/(public)/galaxy/galaxy-shop/page.tsx')
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: '中古Samsung Galaxyを買うならどこ？' },
    ],
  }
  ...
  // ShopDetailSection用データ: shop_keyでマッチング（'apple' は SHOP_DETAIL_ORDER から除外済み）
          ...
          <div className="hero-inner l-container">
            <div className="hero-content">
              <h1 className="hero-title" itemProp="headline">
                中古Samsung Galaxyを買うならどこ？ECサイト・ショップのおすすめを紹介
              </h1>
            ...
            <div className="hero-visual">
              <figure className="hero-media">
                <Image
                  src={getHeroImage('/galaxy/galaxy-shop/')}
                  alt="中古Samsung Galaxyの購入先イメージ"
        ...
        <section className="l-section l-section--sm section-lead" aria-label="記事の導入">
          <div className="l-container">
            <div className="lead-box">
              <p>中古のSamsung Galaxyを買おうと思ったとき、いちばん迷うのが「どこで買うのが正解なのか」という点です。</p>
              <p>
                中古ショップ、キャリア認定中古、ECモール、フリマアプリなど選択肢は多いものの、
                <strong>価格や保証、リスクはそれぞれ大きく異なります。</strong>
              </p>
              <p>
                この記事では、中古Galaxyを購入できる主な場所を比較しながら、「安全に買いたい人」「できるだけ安く買いたい人」「初めて中古を買う人」など、タイプ別におすすめの買い方を整理して解説します。
              </p>
...
<p className="toc-title"><i className="fa-solid fa-list" aria-hidden="true"></i> タップできる目次</p>
          ...
          <section className="l-section" id="shop-table" aria-labelledby="heading-shop-table">
            <div className="l-container">
              <h2 className="m-section-heading m-section-heading--lg" id="heading-shop-table">
                中古Samsung Galaxy取り扱いショップ比較表
              </h2>
              <p className="m-section-desc">中古Galaxyを取り扱うショップの保証・価格・サービスを一覧で比較できます。</p>
              <ShopComparisonTable
                shops={comparisonShops}
                specRows={comparisonSpecRows}
                caption="中古Samsung Galaxy取り扱いショップ比較表"
                getShopUrl={(s) => s.galaxy_url ?? s.url}
                ctaText="詳細を見る"
              />
            </div>
          </section>
    ...
    <GalaxyArticleFooter pageUrl={PAGE_URL} pageTitle={PAGE_TITLE} excludeHref={["/galaxy/galaxy-shop/"]} />
    </>
  )
}
