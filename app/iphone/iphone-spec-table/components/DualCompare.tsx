...
function getBoolDisplay(val: boolean): React.ReactNode {
            ...
            <thead>
              <tr>
                ...
                <td className="compare-table__header-cell">
                  ...
                  <Link href={`/iphone/${modelA.slug}`} className="compare-model-link">
                    このモデルの詳細を見る &rsaquo;
                  </Link>
                  {modelA.image && (
                    <img
                ...
                <td className="compare-table__header-cell">
                  ...
                  <Link href={`/iphone/${modelB.slug}`} className="compare-model-link">
                    このモデルの詳細を見る &rsaquo;
                  </Link>
                  {modelB.image && (
                    <img
