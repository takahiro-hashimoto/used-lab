...
function calcAvgPriceFromLog(log: WatchPriceLog): PriceEntry | null {
...
function seriesOrder(series: string): number {
  const order: Record<string, number> = { Ultra: 1, Series: 2, SE: 3 }
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = `中古Apple Watch${modelCount}機種の相場・値段を毎日更新。Series・SE・Ultraなど歴代モデルの価格推移グラフ・相場一覧を掲載。`
...
export default async function WatchPriceInfoPage() {
  ...
  const webAppJsonLd = buildWebApplicationJsonLd({
    ...
    description: `中古Apple Watch${modelCount}機種の価格相場を毎日更新。価格推移グラフ、相場ランキングを掲載。`,
    url: PAGE_URL,
    modelCount,
        ...
        <section className="l-section l-section--sm section-lead" aria-label="記事の導入">
          <div className="l-container">
            <div className="lead-box">
              <p>中古Apple Watch<strong>{modelCount}機種</strong>の価格相場を毎日更新でお届け。</p>
              <p>
...
<p className="toc-title"><i className="fa-solid fa-list" aria-hidden="true"></i> タップできる目次</p>
        ...
        <div className="l-sections" itemProp="articleBody">
          ...
          <section className="l-section l-section--sm" id="pd-method">
            <div className="l-container">
              <h2 className="m-section-heading m-section-heading--lg">中古Apple Watchの相場価格 算出方法</h2>
              ...
              <div className="l-grid l-grid--3col l-grid--gap-lg">
                <div className="m-card m-card--shadow m-card--padded post-check-item">
                  ...
                  <div className="media-card__desc m-rich-text">
                    ...
                    <p>中古Apple Watchの取引量が多い主要3ショップを対象とすることで、市場全体の価格動向を反映しています。</p>
                ...
                <div className="m-card m-card--shadow m-card--padded post-check-item">
                  ...
                  <div className="media-card__desc m-rich-text">
                    <p>機種ごとの最小サイズ・GPSモデルを対象とし、サイズやセルラー有無による価格差をなくしています。</p>
