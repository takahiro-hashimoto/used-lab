        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">ウェブブラウザで調べ物をする</h3>
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">カーナビ・地図として活用する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">料理レシピを見る</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            <div className="media-card__img-wrap">
              <img
                src="/images/content/photo/ipad-11-pro-m4-16.jpg"
                alt="iPadで朝日新聞を読む様子"
                className="media-card__img"
                width={240}
                height={160}
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">新聞を読む</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">スケジュールを管理する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            <div className="media-card__img-wrap">
              <img
                src="/images/content/photo/centerflame.webp"
                alt="iPadでテレビ電話をする様子"
                className="media-card__img"
                width={240}
                height={160}
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">テレビ電話をする</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">置き時計として使う</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">フォトフレームとして使用する</h3>
              <p className="media-card__desc">
