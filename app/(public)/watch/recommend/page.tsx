            ...
            items={[
              {
                ...
                desc: <><p>中古Apple Watchではバッテリーの劣化が使い心地に直結します。最大容量80%未満の場合、1日持たなくなることも。</p><p>ショップの商品説明でバッテリー状態を確認しましょう。</p></>,
              },
              {
                iconClass: 'fa-solid fa-ruler',
                title: 'ケースサイズを確認する',
                desc: <><p>Apple Watchはモデルによって40/41/42mm（小）と44/45/46/49mm（大）のサイズがあります。</p><p>手首の太さに合わないサイズだと着け心地が悪くなるため、<strong>事前にサイズを確認</strong>しましょう。</p></>,
              },
              {
                iconClass: 'fa-solid fa-shield-halved',
                title: 'ショップ保証の有無を確認',
                desc: <><p>初期不良に対応する<strong>保証期間</strong>をチェック。イオシスなら3ヶ月保証など、ショップによって保証内容は異なります。</p><p>保証がないフリマアプリでの購入はリスクが高いため、初心者にはおすすめしません。</p></>,
              },
              {
                iconClass: 'fa-solid fa-clock-rotate-left',
                title: 'watchOSサポート期間を確認する',
                desc: <><p>発売から約5年でサポート終了するのが過去の傾向です。</p><p>サポートが切れると新しい文字盤やアプリが使えなくなるため、<strong>発売が古すぎる機種</strong>は避けましょう。</p></>,
              },
            ]}
            memoLinks={[
