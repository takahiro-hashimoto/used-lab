  ...
  return (
    <section className="l-section" id="pd-dashboard" aria-labelledby="pd-dashboard-title">
      <div className="l-container">
        ...
        <p className="m-section-desc">
          機種ごとの違いが知りたい方は「<Link href="/iphone/iphone-spec-table/">歴代iPhoneスペック比較表</Link>」をご覧ください。
        </p>
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">
            当サイトの中古相場は、イオシス・ゲオ・じゃんぱらの3店舗から毎日自動取得した最安値・最高値の平均中間値を算出しています。対象は各機種の最小容量モデル（例：iPhone 15なら128GB）で、100円単位に丸めて表示しています。
          </p>
        </div>
      </div>
    </section>
