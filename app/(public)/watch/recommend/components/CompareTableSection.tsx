    ...
    <section className="l-section" id="compare" aria-labelledby="heading-compare">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-compare">
          おすすめApple Watch{RECOMMEND_COUNT_LABEL}のスペック比較表
        </h2>
        ...
        <div className="m-card m-card--shadow m-table-card">
          <div className="m-table-scroll">
            <table className="m-table">
              <caption className="visually-hidden">おすすめ中古Apple Watch{RECOMMEND_COUNT_LABEL}のスペック比較表</caption>
              <thead>
                <tr>
                  <th scope="col">項目</th>
                  {items.map(({ model }) => (
              ...
              <tbody>
                ...
                {/* 健康センサー */}
                <tr>
                  <th scope="row">健康センサー</th>
                  {items.map(({ model, healthLabel }) => (
                    <td key={model.id}>{healthLabel}</td>
                  ))}
                </tr>
                ...
                {/* イオシスで中古Apple Watchを探す */}
                <tr>
                  <th scope="row">イオシスで中古Apple Watchを探す</th>
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg u-mt-2xl">
          <Link href="/watch/watch-spec-table/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
            ...
            <p className="related-link-card__desc">歴代Apple Watchのスペックを網羅。細かな仕様まで確認</p>
            <span className="related-link-card__arrow">
              <i className="fa-solid fa-chevron-right" aria-hidden="true"></i>
            </span>
          </Link>
          <Link href="/watch/used-watch-support/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
            ...
            <p className="related-link-card__desc">Apple Watchの寿命とサポート期間を機種別に一覧で紹介</p>
            <span className="related-link-card__arrow">
              <i className="fa-solid fa-chevron-right" aria-hidden="true"></i>
            </span>
          </Link>
          <Link href="/watch/used-watch-attention/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
            <span className="related-link-card__icon m-icon-box m-icon-box--sm">
              <i className="fa-solid fa-triangle-exclamation" aria-hidden="true"></i>
            </span>
            <p className="related-link-card__title">購入時の注意点</p>
            <p className="related-link-card__desc">中古Apple Watchを買う前に確認すべきチェックポイント</p>
            <span className="related-link-card__arrow">
              <i className="fa-solid fa-chevron-right" aria-hidden="true"></i>
            </span>
          </Link>
