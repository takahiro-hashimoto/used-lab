import { RECOMMEND_COUNT, RECOMMEND_COUNT_LABEL } from '@/lib/data/iphone-recommend'
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg">
          <div className="m-card m-card--shadow criteria-card">
            <div className="criteria-card__head">
              ...
              <h3 className="criteria-card__title">iOSサポートが十分に残っている</h3>
            </div>
            <p className="criteria-card__desc">
              サポートが切れるとセキュリティリスクが高まり、アプリも使えなくなります。
              <strong>2030年以降までサポートされる機種</strong>だけを選んでいます。
            </p>
          </div>
          ...
          <div className="m-card m-card--shadow criteria-card">
            ...
            <p className="criteria-card__desc">
              普段使い（SNS・Web・動画）で「遅い」「カクつく」と感じにくい性能を基準にしています。
              体感差が出にくい世代以降のモデルに絞って選定しています。
            </p>
          </div>
