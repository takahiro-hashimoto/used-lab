    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <ul>
            <li>iPadOSサポートが終了済み、または終了間近のモデル — セキュリティリスクが高く、新しいアプリが使えなくなる可能性がある</li>
            <li>ストレージ32GBのモデル — アプリを数個入れるだけで容量不足に。iPadはSDカードで増設できないため致命的</li>
            <li>サポート残が1〜2年以内のモデル — 買ってすぐサポート切れになるリスクがある</li>
          </ul>
          <p>
