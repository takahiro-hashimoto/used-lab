        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">文字盤のカスタマイズを楽しむ</h3>
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">ベルト・ケースを交換する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">経路案内で目的地へ向かう</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">再生している音楽・動画のコントロールする</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">iPhoneの通知を確認する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">LINEやショートメッセージの中身を確認する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">振動アラームが使える</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">Siriでタイマーを起動する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">電話に出る・かける</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">iPhoneのカメラでリモート撮影する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">トランシーバーアプリで会話する</h3>
              <p className="media-card__desc">
          ...
          <div className="m-card m-card--shadow m-card--padded">
            ...
            <div className="media-card__body">
              <h3 className="media-card__title">懐中電灯・フラッシュライトとして使う</h3>
              <p className="media-card__desc">
                Apple Watchには、手元を照らすのに便利な3種類の懐中電灯（フラッシュライト）モードが搭載されています。
              </p>
              <dl className="m-card vs-card" style={{ marginTop: 'var(--space-sm)' }}>
                <dt>白く点灯</dt>
                <dd>周囲の暗い場所や暗闇の道を照らす、手元作業、停電時の補助照明など、一般的な懐中電灯として活用できます。</dd>
                <dt>白く点滅</dt>
                <dd>暗い時間帯のランニングやウォーキング時に、周囲に自分の存在を知らせるセーフティーライトとして活用し、事故を防ぎます。</dd>
                <dt>赤く点灯</dt>
                <dd>夜間の暗所で、視界を極力妨げずに手元を見たい場合に使います（例：天体観測時、家族を起こしたくない時など）。</dd>
              </dl>
              <p className="media-card__desc" style={{ marginTop: 'var(--space-md)' }}>
