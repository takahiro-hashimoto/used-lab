      ...
      <div className="l-container">
              ...
              >
                <div className="pd-history-summary-left">
                  <h3 className="pd-history-model-name">
                    <a href={`/iphone/${model.slug}/`} className="pd-history-model-link" onClick={(e) => e.stopPropagation()}>{model.name}</a>
                  </h3>
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">
            当ページでは、中古iPhone全{models.length}機種の価格推移データを毎日更新で公開しています。イオシス・ゲオ・じゃんぱらの3店舗から自動取得した実売価格をもとに、最安値・最高値・平均相場を算出。過去90日間の日別データと月別サマリーにより、価格トレンドを把握できます。
          </p>
          <p className="m-callout__text">
