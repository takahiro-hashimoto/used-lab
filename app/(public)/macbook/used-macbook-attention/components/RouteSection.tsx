      ...
      <div className="l-container">
        ...
        >
          <div className="media-card__desc m-rich-text">
            ...
            <p>
              また、MacBookは同じモデル名でもメモリ・ストレージ構成が複数あるため、スペック表記を必ず確認してください。「MacBook Air M2」とだけ書かれていても、8GB/256GBと16GB/512GBでは価格も使い勝手も大きく異なります。ストレージ選びに迷ったら「<Link prefetch={false} href="/macbook/storage-guide/">ストレージ容量ガイド</Link>」も参考にしてください。
            </p>
          </div>
        </MediaCard>
