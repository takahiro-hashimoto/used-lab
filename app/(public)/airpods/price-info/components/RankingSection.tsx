            ...
            >
                  ...
                  <div className="ifd-result-card__tags">
                    {model.supportEnded ? (
                      ...
                      <span className="ifd-tag ifd-tag--supported">
                        <i className="fa-solid fa-shield-halved" aria-hidden="true"></i> サポート {model.supportUntil}まで
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="ifd-result-card__body">
                ...
                <dl className="ifd-result-card__specs">
                  ...
                  <div><dt>チップ</dt><dd>{model.chip}</dd></div>
                  <div><dt>タイプ</dt><dd>{model.type}</dd></div>
