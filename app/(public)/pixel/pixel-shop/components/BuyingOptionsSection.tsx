    ...
    <section className="l-section" id="shops" aria-labelledby="heading-shops">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-shops">
          中古Google Pixelはどこで買える？主な購入先4つ
        </h2>
        <p className="m-section-desc">中古Google Pixelを購入できる場所は大きく分けて4つあります。</p>
        ...
        <div className="l-grid l-grid--2col l-grid--gap-lg u-mt-xl">
          ...
          <IconCard icon="fa-solid fa-store" title="中古スマホ専門店">
              <p>イオシス、にこスマ、ゲオなど、中古スマホを専門に扱うショップ。Pixelを含むAndroidの取り扱いも豊富で、独自の保証制度や検品体制を整えています。</p>
          </IconCard>

          {/* キャリア認定中古 */}
          <IconCard icon="fa-solid fa-mobile-screen-button" title="キャリア認定中古">
              <p>ドコモやauなどの通信キャリアが販売する認定整備済みスマホ。PixelはGoogleストアやキャリアで正規に扱われており、キャリア独自の保証が付帯します。</p>
          </IconCard>
