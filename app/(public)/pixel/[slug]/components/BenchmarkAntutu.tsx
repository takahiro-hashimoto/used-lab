...
function getAntutuTotal(m: PixelModel): number {
    ...
    <section className="l-section" id="antutu" aria-labelledby="heading-antutu">
      <div className="l-container">
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">ベンチマークについてもっと詳しく知りたい方は「<Link prefetch={false} href="/pixel/benchmark/">歴代Google Pixelベンチマーク比較</Link>」もあわせてご覧ください。</p>
        </div>
      </div>
    </section>
  )
