...
export const GUIDE_SPEC_LINKS = [
  ...
  { href: '/watch/apple-watch-buy/', icon: 'fa-tags', title: 'Apple Watchを安く買う方法まとめ', desc: 'Apple認定整備済製品・中古ショップ・ECモール・家電量販店など7つの購入先を価格・保証で比較。' },
] as const
...
export const GUIDE_FAQ_ITEMS = [
  ...
  {
    question: 'Apple Watchのバンドは他のモデルでも使い回せますか？',
    answer: 'Apple Watchのバンドは同じケースサイズ系統であれば世代をまたいで互換性があります。38mm/40mm/41mm系と42mm/44mm/45mm系でそれぞれ共通です。Ultra（49mm）は45mm系バンドも装着可能ですが、Ultra専用バンドは他モデルには使えません。中古で購入する場合はバンドが付属しないケースもあるため、別途購入が必要か事前に確認しましょう。',
  },
  {
