          ...
          <div className="l-sections" id="content" itemProp="articleBody">
              ...
              <div className="l-container">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
                  ...
                  <div className="m-card m-card--shadow m-card--padded">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/apple-watch-face.jpg" alt="Apple Watchの画面イメージ" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
                  ...
                  <div className="m-card m-card--shadow m-card--padded" id="battery">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/torras-flasheye-review-4.jpg" alt="Apple Watchの充電イメージ" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
                  ...
                  <div className="m-card m-card--shadow m-card--padded" id="repair-cost">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/apple-watch-unlock-macbook.jpg" alt="Apple Watchを使用する様子" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
                  ...
                  <div className="m-card m-card--shadow m-card--padded" id="warranty">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/apple-watch-image-1-1.jpg" alt="Apple Watchを日常使用するイメージ" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
                  ...
                  <div className="m-card m-card--shadow m-card--padded">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/used-lab-image.jpg" alt="Apple Watchを使うイメージ" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
            ...
            <section className="l-section" id="should-join" aria-labelledby="heading-should-join">
              <div className="l-container">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }} className="u-mt-2xl">
                  ...
                  <div className="m-card m-card--shadow m-card--padded">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/G0uLO0EbcAA9rwj.webp" alt="Apple Watch Ultraのイメージ" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
                  ...
                  <div className="m-card m-card--shadow m-card--padded">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/ipad-children.jpg" alt="子どもがタブレットを触る様子" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
                  ...
                  <div className="m-card m-card--shadow m-card--padded">
                    <div className="media-card__img-wrap">
                      <img src="/images/content/photo/iphone-broken.jpg" alt="画面がひび割れたiPhone" className="media-card__img" width={800} height={450} loading="lazy" />
                    </div>
                    <div className="media-card__body">
            ...
            <section className="l-section" id="used-watch" aria-labelledby="heading-used-watch">
              <div className="l-container">
                ...
                <div className="m-card m-card--shadow m-card--padded u-mt-2xl">
                  <div className="media-card__img-wrap">
                    <img src="/images/content/photo/apple-watch-image-1-1.jpg" alt="Apple Watchのイメージ" className="media-card__img" width={800} height={450} loading="lazy" />
                  </div>
                  <div className="media-card__body">
