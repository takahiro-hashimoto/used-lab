    ...
    <section className="l-section" id="recommend" aria-labelledby="heading-recommend">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-recommend">
          <i className="fa-solid fa-bullseye" aria-hidden="true"></i> 目的別｜中古Samsung Galaxyはここで買うのがおすすめ
        </h2>
        <p className="m-section-desc">中古Galaxyの購入先で迷う人は、ほとんどが次の3タイプのいずれかに当てはまります。</p>
        ...
        <div className="m-card m-card--shadow m-card--padded u-mt-xl">
          <h3 className="post-check-item__heading text-info">
            <i className="fa-solid fa-shield-halved" aria-hidden="true"></i> 安全重視・初めて中古Galaxyを買う人
          </h3>
        ...
        <div className="m-card m-card--shadow m-card--padded u-mt-lg">
          ...
          <div className="media-card__desc m-rich-text">
            <p>中古Galaxyの相場感があり、自分で状態を確認できる方は<strong>中古スマホ専門店（価格重視店）</strong>や<strong>ECモール（楽天市場・Amazonなど）</strong>を検討してみましょう。</p>
        ...
        <div className="m-card m-card--shadow m-card--padded u-mt-lg">
          ...
          <div className="media-card__desc m-rich-text">
            ...
            <p>専門店で買うよりもお手頃な価格で手に入る可能性があります。ただし、保証がなくリスクが高い点には注意しましょう。バッテリー状態・赤ロム・モデルのサポート期間を自分で判断できることが前提です。</p>
          </div>
        </div>
      </div>
    </section>
