    ...
    <section className="l-section" id="shops" aria-labelledby="heading-shops">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-shops">
          中古{model.model}を安く買えるECサイト
        </h2>
        <p className="m-section-desc">
          信頼性の高い中古ショップを厳選し、保証期間やバッテリー保証の有無などをまとめました。
        </p>
        <p className="m-section-desc">
          気になるECサイトにアクセスして{model.model}の中古価格や在庫数をチェックしましょう。
        </p>
        ...
        <div className="m-callout m-callout--tip" style={{ marginTop: 'var(--space-2xl)' }}>
          ...
          <p className="m-callout__text">
            購入先を比較したい方は「<a href="/watch/watch-shop/">中古Apple Watchはどこで買う？おすすめECサイトまとめ</a>」もあわせてご覧ください。
          </p>
        </div>
      </div>
    </section>
