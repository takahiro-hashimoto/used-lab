export default function FindMethodSection() {
  ...
  return (
    <div style={{ marginTop: 'var(--space-2xl)' }}>
      ...
      {/* 探すアプリで探す */}
      <h3 className="m-sub-heading" style={{ marginTop: 'var(--space-2xl)' }}>
      ...
      <div className="step-list" style={{ marginTop: 'var(--space-lg)' }}>
        <div className="m-card m-card--padded step-item">
          <span className="step-number">1</span>
          <div>
            <h4 className="step-title">「探す」が有効になっていることを確認する</h4>
            <p className="step-desc">「探す」機能を使用するには、設定画面で「探す」が有効になっている必要があります。まずは状態を確認しましょう。</p>
          </div>
        </div>
        <div className="m-card m-card--padded step-item">
          <span className="step-number">2</span>
          <div>
            <h4 className="step-title">「探す」アプリを立ち上げてAirPodsを選択</h4>
            <p className="step-desc">アプリの「デバイスを探す」からAirPodsを選択します。最後にBluetooth接続が切れた場所と時刻が表示されます。接続範囲内なら音を鳴らして捜索することも可能です。</p>
          </div>
        </div>
        <div className="m-card m-card--padded step-item">
          <span className="step-number">3</span>
          <div>
            <h4 className="step-title">どうしても見つからない場合は「紛失モード」に切り替える</h4>
            <p className="step-desc">紛失モードをONにすると、他のiPhoneユーザーがAirPodsの近くを通った時に位置情報が通知されたり、拾った方にメッセージを表示できます。</p>
          </div>
        </div>
      </div>
      ...
      <div className="step-list" style={{ marginTop: 'var(--space-lg)' }}>
        <div className="m-card m-card--padded step-item">
          <span className="step-number">1</span>
          <div>
            <h4 className="step-title">iCloudへログインする</h4>
        ...
        <div className="m-card m-card--padded step-item">
          <span className="step-number">2</span>
          <div>
            <h4 className="step-title">「探す」アプリを開く</h4>
            <p className="step-desc">管理画面の中にある「探す」アプリをクリックします。</p>
          </div>
        </div>
        <div className="m-card m-card--padded step-item">
          <span className="step-number">3</span>
          <div>
            <h4 className="step-title">デバイスの中からAirPodsを選択</h4>
            <p className="step-desc">所有しているApple製品の中からAirPodsを選択し、位置をチェックします。</p>
          </div>
        </div>
      </div>
    </div>
