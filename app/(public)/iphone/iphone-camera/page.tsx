      ...
      <article itemScope itemType="https://schema.org/Article">
        ...
        <FaqSection
          ...
          items={[
            ...
            {
              question: 'iPhoneのカメラは何世代から大きく進化しましたか？',
              answer: '大きな進化のタイミングは主に3つあります。まず「iPhone 11」世代で超広角カメラが追加され、構図の幅が大きく広がりました。次に「iPhone 12 Pro」でナイトモードやApple ProRAW、LiDARスキャナが登場し、プロ寄りの撮影が可能に。そして「iPhone 14 Pro」では4800万画素の高解像度センサーを搭載し、画質が飛躍的に向上しました。\n中古で選ぶなら、iPhone 11以降であれば超広角対応、iPhone 12 Pro以降ならさらに本格的な撮影が楽しめます。',
            },
            {
              question: 'ProモデルとProでないモデルでカメラの差は大きいですか？',
              answer: '用途によっては大きな差があります。Proモデルの主な優位点は「光学望遠レンズ（3〜5倍）」「LiDARスキャナ」「Apple ProRAW/ProRes対応」「より大きなイメージセンサー」の4点です。\n日常のスナップや自撮り、SNS投稿が中心であれば無印モデルで十分満足できます。一方、遠くの被写体を撮る機会が多い・動画をこだわって撮りたい・RAW現像を楽しみたいといった場合はProモデルが一線を画します。',
            },
            {
              question: '中古iPhoneのカメラ性能は劣化しますか？',
              answer: 'カメラのレンズや画像処理チップ自体は経年劣化しにくく、基本的な撮影性能は新品時と変わりません。ただし、レンズ表面のコーティングが剥がれたり、傷がついている個体では画質に影響が出ることがあります。\n購入前に実際の撮影サンプルを確認するか、「Sランク」「美品」など外観状態の評価が高い個体を選ぶのがおすすめです。バッテリーとは異なり、カメラ機能そのものは長期間にわたって安定して使えます。',
            },
          ]}
        />
