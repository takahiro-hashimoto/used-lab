...
const PAGE_URL = 'https://used-lab.jp/watch/apple-watch-buy/'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: getHeroImage('/watch/apple-watch-buy/'), width: 1200, height: 630, alt: PAGE_TITLE }],
  },
  twitter: {
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    images: [getHeroImage('/watch/apple-watch-buy/')],
  },
}
          ...
          <div className="hero-inner l-container">
            ...
            <div className="hero-visual">
              <figure className="hero-media">
                <Image
                  src={getHeroImage('/watch/apple-watch-buy/')}
          ...
          <div className="l-container">
            <div className="lead-box">
              ...
              <p className="lead-link">
                ...
                中古Apple Watchの選び方から知りたい方は「<Link prefetch={false} href="/watch/">中古Apple Watch購入ガイド</Link>」をご覧ください。
              </p>
            </div>
          </div>
        </section>
