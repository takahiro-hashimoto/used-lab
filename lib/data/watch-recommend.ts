...
export const RECOMMEND_META: Record<string, RecommendMeta> = {
  'series10': {
    ...
    description: [
      '毎日つけるApple Watchが欲しいという方に合うのが、2024年発売のSeries 10です。Apple Watchとしては最薄・最軽量のデザインで、S10 SiPチップにより処理性能も十分。装着感が軽いので、睡眠トラッキング中も違和感がありません。',
      ...
      'この秋のwatchOS 27でSeries 9以前が一斉にサポート対象外になるため、スタンダードモデルで今後も安心して使えるのはSeries 10以降だけになります。中古でスタンダードを選ぶなら、Series 10が実質的な最低ラインです。',
    ],
    good: [
      '薄くて軽いモデルを毎日つけたい',
      '睡眠時無呼吸アラートを活用したい',
  ...
  'se3': {
    ...
    description: [
      ...
      '2025年発売なのでwatchOSサポートは2030年頃まで続く見込みです。3機種の中では中古相場がもっとも手ごろで、Apple Watchデビューにいちばん向いた選択肢と言えます。',
    ],
    good: [
  ...
  'ultra2': {
    ...
    description: [
      ...
      'Ultra 3が登場したことで中古相場は下がり、いまはSeries 10より少し高い程度で狙えます。流通量も安定しているので、状態やバンドの組み合わせを比べながら選べるタイミングです。',
    ],
    good: [
      'バッテリー持ちを最優先したい',
      'アウトドアやスポーツでハードに使いたい',
