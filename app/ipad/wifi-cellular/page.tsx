    ...
    <main>
      <article itemScope itemType="https://schema.org/Article">
        ...
        <div id="content" itemProp="articleBody">
          ...
          {/* セクション: 4つの違い */}
          <section className="l-section l-section--bg-subtle" id="differences" aria-labelledby="heading-differences">
            <div className="l-container">
              <h2 className="m-section-heading m-section-heading--lg" id="heading-differences">
                iPad セルラーモデルとWi-Fiモデルの4つの違い
              </h2>
              <p className="m-section-desc">
                iPadのWi-Fiモデルとセルラーモデルには、通信方式・背面デザイン・GPS・テザリングの4つの違いがあります。まずは一覧表で全体像を把握しましょう。
              </p>
              ...
              <div className="l-grid l-grid--2col l-grid--gap-lg">
                ...
                {/* 1. データ通信方式 */}
                <div className="m-card m-card--shadow popular-card" style={{ gridTemplateColumns: '1fr' }}>
                  ...
                  <div className="popular-card-body">
                    ...
                    <div className="m-card" style={{ padding: 'var(--space-lg)', display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
                      <div>
                        ...
                        <p className="popular-card-desc">通信キャリアと契約してSIMカードを挿すことで、どこでもモバイルデータ通信が可能</p>
                      </div>
                      <hr style={{ border: 'none', borderTop: '1px dashed var(--color-border-light)' }} />
                      <div>
                        <p style={{ fontWeight: 700 }}>Wi-Fiモデル</p>
                        <p className="popular-card-desc">Wi-Fi環境があるところでしかインターネットに接続することができない</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="m-card m-card--shadow popular-card" style={{ gridTemplateColumns: '1fr' }}>
                  ...
                  <div className="popular-card-body">
                    ...
                    <p className="popular-card-desc">
                      ちなみにWi-FiモデルのiPadでもネット接続をすれば位置情報を取得することは可能。ただし、GPS機能を搭載したセルラーモデルと比較すると精度がやや劣るので注意が必要です。
                    </p>
                  </div>
                </div>
          ...
          <section className="l-section" id="recommendation" aria-labelledby="heading-recommendation">
            <div className="l-container">
              ...
              <p className="m-section-desc">
                ここまでの違いを踏まえて、Wi-Fiモデル・セルラーモデルそれぞれがどんな方におすすめかをまとめます。
              </p>
          ...
          {/* セクション: おすすめSIM */}
          <section className="l-section l-section--bg-subtle" id="recommend-sim" aria-labelledby="heading-recommend-sim">
            <div className="l-container">
