    ...
    <section className="l-section" id="compare" aria-labelledby="heading-compare">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-compare">
          おすすめiPhone{RECOMMEND_COUNT_LABEL}のスペック比較表
        </h2>
          ...
          <div className="m-table-scroll">
            <table className="m-table">
              ...
              <tbody>
                ...
                {/* イオシスで中古iPhoneを探す */}
                <tr>
                  <th scope="row">イオシスで中古iPhoneを探す</th>
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg u-mt-2xl">
          ...
          <Link href="/iphone/used-iphone-support/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
          ...
          <Link href="/iphone/used-iphone-attention/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
            <span className="related-link-card__icon m-icon-box m-icon-box--sm">
