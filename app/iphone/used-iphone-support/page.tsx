...
const PAGE_URL = 'https://used-lab.com/iphone/used-iphone-support/'
  ...
  return (
    <main>
      <article>
          ...
          <div className="hero-inner l-container">
            <div className="hero-content">
              <h1 className="hero-title">
                iPhoneはいつまで使える？<br />機種別のサポート期間目安まとめ
              </h1>
              <p className="hero-description">
                iOSサポート期間、修理受付の目安、買い替えるべきタイミングを機種別に徹底解説
              </p>
        ...
        {/* セクション */}
        <IosSupportMatrix models={allModels} />
        <LifespanTable />
        <TimingSection />
        <PopularSection />
        <FaqSection />
