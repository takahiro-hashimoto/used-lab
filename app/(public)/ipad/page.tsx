...
const PAGE_TITLE = `【${GUIDE_DATE_LABEL}】中古iPadおすすめ5選。狙い目の型落ちモデルはどれ？`
...
export default async function IPadGuidePage() {
  ...
  const { dateStr, dateDisplay } = resolveCategoryPageDate(recommendPrices, 'app/(public)/ipad/page.tsx')
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '中古iPadおすすめ機種・選び方ガイド' },
    ],
  }
  ...
  const recommendListJsonLd = buildRecommendItemListJsonLd({
    name: '中古iPadおすすめ機種',
    items: recommendModels.map((m) => ({ name: m.model, url: `https://used-lab.jp/ipad/${m.slug}/` })),
  })
      ...
      <article itemScope itemType="https://schema.org/Article">
          ...
          <div className="hero-inner l-container">
            <div className="hero-content">
              <h1 className="hero-title" itemProp="headline">
                【{GUIDE_DATE_LABEL}】中古iPadおすすめ5選。狙い目の型落ちモデルはどれ？
              </h1>
        ...
        <div className="l-sections">
          ...
          <CompareTableSection
            ...
            descriptions={[
              <>当サイトでおすすめしている機種は下記の通り。スペックの詳細な比較は<Link prefetch={false} href="/ipad/ipad-spec-table/">iPadスペック比較表</Link>をご覧ください。{GUIDE_DATE_LABEL}時点で「iPadOSサポートが十分に残っている」「中古価格と性能のバランスが良い」ことが判断基準です。</>,
            ]}
          />
