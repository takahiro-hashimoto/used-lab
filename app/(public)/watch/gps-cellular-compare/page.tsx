...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: getHeroImage('/watch/gps-cellular-compare/'), width: 1200, height: 630, alt: PAGE_TITLE }],
  },
  twitter: {
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    images: [getHeroImage('/watch/gps-cellular-compare/')],
  },
}
          ...
          <div className="hero-inner l-container">
            ...
            <div className="hero-visual">
              <figure className="hero-media">
                <Image
                  src={getHeroImage('/watch/gps-cellular-compare/')}
          ...
          <div className="l-container">
            <div className="lead-box">
              ...
              <p className="lead-link">
                ...
                中古Apple Watchの選び方全般は「<Link prefetch={false} href="/watch/">中古Apple Watchおすすめ機種・選び方ガイド</Link>」をご覧ください。
              </p>
            </div>
          </div>
        </section>
