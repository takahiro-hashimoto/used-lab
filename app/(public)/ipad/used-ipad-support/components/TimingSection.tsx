...
const TIMING_CARDS: TimingCard[] = [
  {
    ...
    imgSrc: '/images/content/thumbnail/ipad-lightroom.jpg',
    imgAlt: 'iPadのホーム画面',
    content: (
      <>
  ...
  },
  {
    ...
    imgSrc: '/images/content/thumbnail/ipad-use.jpg',
    imgAlt: 'バッテリーの状態画面',
    content: (
      <>
  ...
  },
  {
    ...
    imgSrc: '/images/content/thumbnail/ipad-image-12.jpg',
    imgAlt: 'iPadの性能イメージ',
    content: (
      <>
        ...
        <p>
          ...
          各世代の性能差が気になる方は
          <Link prefetch={false} href="/ipad/ipad-spec-table/">歴代iPadのスペック比較</Link>
          をチェックしてみてください。
        </p>
      </>
    ),
      ...
      afterContent={
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">
            ...
            <Link prefetch={false} href="/ipad/used-ipad-attention/">中古iPadの注意点まとめ</Link>で詳しく解説しています。
          </p>
        </div>
      }
    />
