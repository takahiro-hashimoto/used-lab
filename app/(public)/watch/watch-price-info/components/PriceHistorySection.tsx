      ...
      <div className="l-container">
              ...
              >
                <div className="pd-history-summary-left">
                  <h3 className="pd-history-model-name">
                    <a href={`/watch/${model.slug}/`} className="pd-history-model-link" onClick={(e) => e.stopPropagation()}>{model.name}</a>
                  </h3>
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">
            当ページでは、中古Apple Watch全{models.length}機種の価格推移データを毎日更新で公開しています。イオシス・ゲオ・じゃんぱらの3店舗から自動取得した実売価格をもとに、最安値・最高値・平均相場を算出。過去90日間の日別データと月別サマリーにより、価格トレンドを把握できます。
          </p>
          <p className="m-callout__text">
            Apple Watch Ultra（Ultra 2/Ultra）、Apple Watch Series（Series 10/9/8/7）、Apple Watch SE（SE3/SE2/SE）など、現行モデルから型落ちモデルまで網羅。新型発売後の値下がりタイミングや、お買い得な時期の見極めにご活用ください。
          </p>
        </div>
      </div>
    </section>
