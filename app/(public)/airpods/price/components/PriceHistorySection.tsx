    ...
    <section className="l-section" id="pd-history" aria-labelledby="pd-history-title">
      <div className="l-container">
        ...
        <div className="pd-history-seo">
          <p>
            当ページでは、中古AirPods全{models.length}機種の価格推移データを毎日更新で公開しています。イオシス・じゃんぱら・eイヤホンの3店舗から自動取得した実売価格をもとに、最安値・最高値・平均相場を算出。過去90日間の日別データと月別サマリーにより、価格トレンドを把握できます。
          </p>
          <p>
            AirPods Max、AirPods Pro（第2/1世代）、AirPods（第4/3/2/1世代）など、現行モデルから型落ちモデルまで網羅。新型発売後の値下がりタイミングや、お買い得な時期の見極めにご活用ください。
          </p>
        </div>
      </div>
    </section>
