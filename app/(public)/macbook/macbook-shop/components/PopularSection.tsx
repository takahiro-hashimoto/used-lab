...
export default function PopularSection() {
  return (
    <PopularSectionBase
      ...
      sectionDescription="目的別におすすめの機種を厳選。購入すべき中古MacBookをさくっと知りたい方はぜひご覧ください。"
      imageSrc="/images/content/thumbnail/macbook-image-04.jpg"
      imageAlt="中古MacBookおすすめのイメージ画像"
      subtitle="目的別におすすめ機種を厳選！"
      cardTitle="中古MacBookおすすめモデル"
      cardDescription="コスパ重視、クリエイティブ向け、持ち運び重視など目的別に買うべきモデルを紹介。チップ性能やメモリ、バッテリー持ち、macOSサポート期間など購入前にチェックすべき項目も網羅しています。"
