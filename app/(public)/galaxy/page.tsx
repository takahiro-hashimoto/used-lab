    ...
    <main>
      <article>
        ...
        <div className="l-sections">
          ...
          {/* ========== 絞り込みツール ========== */}
          <PopularSection
            sectionTitle="条件に合うGalaxyを絞り込む"
            sectionDescription="予算・シリーズ・S Pen対応・DeX対応など、ご自身の条件を選ぶことで候補を絞り込めます。"
            imageSrc="/images/content/thumbnail/simulator.jpg"
            imageAlt="Galaxy機種絞り込みツール"
            subtitle="条件にチェックを打つだけ！"
            cardTitle="Galaxy機種絞り込みツール"
            cardDescription="S PenやDeXを使いたい、折りたたみが欲しい、といった希望や予算にチェックを打つだけで、条件に合う中古Galaxyを絞り込めます。OSアップデートの期限はSamsungの公表値で表示するので、長く使える機種も選べます。"
            buttonText="機種診断スタート"
            buttonHref="/galaxy/galaxy-filter-search/"
