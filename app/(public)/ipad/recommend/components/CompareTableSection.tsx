    ...
    <section className="l-section" id="compare" aria-labelledby="heading-compare">
      <div className="l-container">
          ...
          <div className="m-table-scroll">
            <table className="m-table">
              ...
              <tbody>
                ...
                {/* イオシスで中古iPadを探す */}
                <tr>
                  <th scope="row">イオシスで中古iPadを探す</th>
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg u-mt-2xl">
          <Link href="/ipad/ipad-spec-table/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
          ...
          <Link href="/ipad/used-ipad-support/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
          ...
          <Link href="/ipad/used-ipad-attention/" className="m-card m-card--shadow related-link-card related-link-card--icon m-card--hoverable">
            <span className="related-link-card__icon m-icon-box m-icon-box--sm">
