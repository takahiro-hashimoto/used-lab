      ...
      <div className="l-container">
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <div className="m-callout__links">
            <Link prefetch={false} href="/ipad/apple-pencil-compare/" className="m-callout__link">
              <i className="fa-solid fa-pen-nib" aria-hidden="true"></i> Apple Pencil対応比較表
            </Link>
            <Link prefetch={false} href="/ipad/accessories-summary/" className="m-callout__link">
