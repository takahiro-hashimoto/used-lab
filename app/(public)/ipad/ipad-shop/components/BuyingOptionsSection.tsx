    ...
    <section className="l-section" id="shops" aria-labelledby="heading-shops">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="heading-shops">
          中古iPadはどこで買える？主な購入先4つ
        </h2>
        <p className="m-section-desc">中古iPadを購入できる場所は大きく分けて4つあります。</p>
        <p className="m-section-desc">それぞれの特徴を簡単に把握しておきましょう。</p>

        <div className="l-grid l-grid--2col l-grid--gap-lg post-check-grid">
          <IconCard icon="fa-solid fa-store" title="中古タブレット専門店">
              <p>イオシス、にこスマ、ゲオなど、中古スマホ・タブレットを専門に扱うショップ。独自の保証制度や検品体制を整えています。</p>
          </IconCard>

          <IconCard icon="fa-solid fa-apple-whole" title="Apple認定整備済製品">
              <p>Apple公式が整備した中古iPad。新品同様のバッテリーと外装、1年間のメーカー保証が付帯します。</p>
          </IconCard>
