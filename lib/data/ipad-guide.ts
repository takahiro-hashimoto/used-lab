// ============================================================
// 中古iPadおすすめ機種・選び方ガイドページ — 一元管理データ
// ============================================================
...
export const GUIDE_FAQ_ITEMS = [
  {
    ...
    answer: '用途や予算に応じて最適なモデルは異なります。イラスト・動画編集ならProシリーズ、コスパ重視ならiPad（無印）、持ち運び重視ならiPad mini、バランス重視ならiPad Airがおすすめです。「[iPad機種診断シミュレーター](/ipad/ipad-filter-search/)」で条件を絞り込むと、あなたに合った機種が見つかります。',
  },
  {
    question: 'iPadのスペックを比較したい',
    answer: '「[歴代iPadスペック比較表](/ipad/ipad-spec-table/)」で、歴代iPadのスペックを並べて比較できます。Apple Pencilの対応状況は「[Apple Pencil対応比較表](/ipad/apple-pencil-compare/)」でご覧いただけます。',
  },
  {
    question: '中古iPadを買うベストなタイミングはいつですか？',
    answer: '新型iPad発売直後は旧モデルの価格が下がりやすい傾向があります。また、年末年始や決算期（3月）もセールが行われることが多いです。当サイトの[価格推移グラフ](/ipad/ipad-price-info/)で、値下がり傾向を確認してから購入するのがおすすめです。',
  },
  {
    question: 'Wi-FiモデルとCellularモデルどちらを選ぶべき？',
    answer: '自宅やWi-Fi環境での利用がメインならWi-Fiモデルで十分です。外出先でも単体で通信したい場合はCellularモデルがおすすめですが、スマホのテザリングでも代用可能です。詳しくは「[Wi-Fi vs Cellularモデル比較](/ipad/wifi-cellular/)」をご覧ください。',
  },
  {
    question: '中古iPadはどこで買うのがおすすめですか？',
    answer: '信頼性と保証の観点から、イオシス・ゲオ・じゃんぱらなどの大手中古専門店がおすすめです。これらの店舗では動作確認済みの端末を扱い、初期不良保証も付いています。詳しくは「[中古iPadを安心して購入できるECサイト](/ipad/ipad-shop/)」をご覧ください。',
  },
  {
    question: '中古iPadはいつまで使えますか？',
    answer: 'iPadはAppleの発売から約6〜7年間iPadOSアップデートのサポートを受けられます。長く使いたい場合は、発売から3年以内のモデルを選ぶと安心です。詳しくは「[iPadOSサポート期間一覧表](/ipad/used-ipad-support/)」をご覧ください。',
  },
  {
    question: 'Apple Pencilはどの世代のiPadに対応していますか？',
    answer: 'Apple Pencilには第1世代、第2世代、USB-C、Proの4種類があり、対応するiPadモデルが異なります。購入前に必ず対応状況を確認しましょう。「[Apple Pencil対応比較表](/ipad/apple-pencil-compare/)」で各モデルの対応状況を一覧で確認できます。',
  },
  {
  ...
  {
    question: '中古iPadでもApple Care+に加入できますか？',
    answer: 'できません。Apple Care+はiPadの購入から30日以内にのみ加入できるため、中古品への加入は対象外です。詳しくは「[iPadにApple Care+は必要？](/ipad/apple-care/)」で解説しています。',
  },
]
