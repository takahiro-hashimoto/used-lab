 ...
 * 各用途で快適に動作するSamsung Galaxyの目安を下限として設定。
 *
 * - SNS/Web: Aシリーズ〜旧Sシリーズ相当 (Single ~1,000 / Multi ~2,900) で十分
 * - 写真・カメラ: 旧世代Sシリーズ相当 (Single ~1,050 / Multi ~3,200) が目安
 * - ゲーム（一般）: Snapdragon 8 Gen 1〜2世代 (Single ~1,700 / Multi ~4,400 / AnTuTu ~1,000,000) が快適ライン
 * - 動画・編集: Snapdragon 8 Gen 2 for Galaxy 相当 (Single ~1,750 / Multi ~4,600 / AnTuTu ~1,050,000) 推奨
 * - ヘビーゲーム: 最新Snapdragon 8系フラッグシップ (Single ~1,900 / Multi ~4,600 / AnTuTu ~1,200,000) 推奨
 */
type GalaxyUseCase = {
  icon: string
  title: string
...
const USE_CASES: GalaxyUseCase[] = [
  ...
  },
  {
    icon: 'fa-camera',
    title: 'カメラ・写真',
    description: '夜景モードや高倍率ズームなどカメラ重視',
    singleMin: 1050,
    multiMin: 3200,
    antutuMin: null,
  },
  ...
  },
  {
    ...
    title: '動画・Galaxy AI',
    description: '4K撮影やGalaxy AI・生成AI編集を活用',
    singleMin: 1750,
    multiMin: 4600,
    antutuMin: 1050000,
  },
...
function findBestMatch(models: GalaxyBenchModel[], uc: GalaxyUseCase): GalaxyBenchModel | null {
      ...
      <div className="l-container">
                ...
                {bestModel && (
                  <div className="usecase-card__recommend">
                    <div className="usecase-card__recommend-left">
                      ...
                      <Link prefetch={false} href={`/galaxy/${bestModel.slug}/`} className="usecase-card__recommend-name">
                        {bestModel.model}
                      </Link>
                    </div>
        ...
        <div className="m-callout m-callout--tip u-mt-2xl">
          ...
          <p className="m-callout__text">
            上記の推奨スコアは<a href="https://browser.geekbench.com/android-benchmarks" target="_blank" rel="noopener noreferrer">Geekbench 6 公式ベンチマーク</a>やAnTuTu v11の実測値をもとに、各用途で快適に動作するSamsung Galaxyの下限を目安として設定しています。予算に余裕があればSnapdragon 8系フラッグシップ（SシリーズやZシリーズ）を選ぶと、長期サポートと相まって数年後もストレスなく使い続けられます。
          </p>
        </div>
      </div>
    </section>
