      ...
      <article itemScope itemType="https://schema.org/Article">
        ...
        <div className="l-sections">
          ...
          <CompareTableSection
            ...
            descriptions={[
              <>当サイトでおすすめしている機種は下記の通り。スペックの詳細な比較は<a href="/ipad/ipad-spec-table/">iPadスペック比較表</a>をご覧ください。{GUIDE_DATE_LABEL}時点で「iPadOSサポートが十分に残っている」「中古価格と性能のバランスが良い」ことを判断基準に、本当の狙い目モデルだけを厳選しています。</>,
            ]}
          />
