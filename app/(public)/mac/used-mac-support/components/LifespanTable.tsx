    ...
    items: [
      {
        term: 'セキュリティリスクが高まる',
        description:
          'OSが更新できないと新しい脆弱性が発見されても、Appleからセキュリティアップデートが提供されなくなるため、Macがハッキングや不正アクセスのリスクにさらされる可能性が高くなります。',
      },
      {
        term: '新機能やアプリが利用できない',
        description:
    ...
    items: [
      {
        term: 'ビンテージ製品',
        description:
          '販売終了から5年以上7年未満が経過したiMac・Mac miniが対象。修理に必要なパーツがない場合にサポートが受けられなくなる。',
      },
      {
        term: 'オブソリート製品',
        description:
          '販売終了から7年以上が経ったiMac・Mac miniが対象。Appleの正規修理サポートを一切受けられなくなる。',
      },
    ],
  },
]

type Props = { models: MacModel[] }

export default function MacLifespanTable({ models }: Props) {
  const data = buildMacBookLifespanData(models, '/mac')

  return (
    <LifespanTableBase
      data={data}
      sectionTitle="iMac・Mac miniのサポート期間一覧（寿命予想）"
      sectionDescription={
        <>
      ...
      tableCaption="iMac・Mac mini機種別サポート期間・寿命予想一覧"
      showModelsColumn
