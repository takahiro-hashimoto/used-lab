...
const ALL_PRODUCT_CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { path: '/pixel/pixel-filter-search/', label: 'Pixel機種診断シミュレーター｜自分に合うおすすめ中古Pixelがすぐわかる【2026年版】' },
  ...
  },
  {
    ...
    pages: [
      ...
      { path: '/galaxy/galaxy-filter-search/', label: 'Galaxy機種診断シミュレーター｜自分に合うおすすめ中古Galaxyがすぐわかる【2026年版】' },
...
const ALL_HEADER_NAV_ITEMS: HeaderNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/pixel/pixel-filter-search/', label: 'Pixel機種診断ツール' },
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/galaxy/galaxy-filter-search/', label: 'Galaxy機種診断ツール' },
