    ...
    <div className="u-mt-2xl" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
      ...
      <div className="m-card m-card--shadow m-card--padded">
        ...
        <div className="media-card__body">
          ...
          <p className="media-card__desc">
            デメリットとしてまず挙げられるのが、その価格です。今回は中古で購入しましたが、2024年モデルということもあり、<Link prefetch={false} href="/ipad/ipad-price-info/">中古相場</Link>はまだそれほど下がっていません。少しでも安く手に入れたいのであれば、もう少し時期を待ってからの購入でも良かったかもしれません。
          </p>
          ...
          <p className="lead-link u-mt-sm">
            ...
            <Link prefetch={false} href="/ipad/used-ipad-support/">iPadはいつまで使える？機種別のサポート期間目安まとめ</Link>
          </p>
        </div>
      </div>
      ...
      <div className="m-card m-card--shadow m-card--padded">
        ...
        <div className="media-card__body">
          ...
          <p className="media-card__desc">
            正直なところ、私の用途でもスペックは「オーバースペック気味」だと感じています。M4レベルのパワーが必須となるアプリはまだ少なく、大画面でCADを快適に動かしたいだけであれば、<Link prefetch={false} href="/ipad/air-5/">iPad Air（M1モデル）</Link>などでも十分だったかもしれません。
          </p>
          <p className="media-card__desc u-mt-sm">
