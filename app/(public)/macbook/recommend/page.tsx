            ...
            items={[
              {
                ...
                desc: <><p>MacBookのバッテリーは約1,000回の充放電サイクルが目安です。充放電回数が多いほどバッテリーの劣化が進んでおり、駆動時間が短くなります。</p><p>購入前に「システム情報」から確認できるか、ショップに問い合わせましょう。</p></>,
              },
              {
                iconClass: 'fa-solid fa-hard-drive',
                title: 'ストレージ容量を確認する',
                desc: <><p>MacBookはストレージの後から増設ができません。Web閲覧・事務作業メインなら256GBでも十分ですが、写真や動画編集をする場合は512GB以上を選びましょう。</p><p>容量不足はクラウドや外付けSSDで補う手もあります。</p></>,
              },
              {
                iconClass: 'fa-solid fa-shield-halved',
                title: 'ショップ保証の有無を確認',
                desc: <><p>初期不良やバッテリー異常に対応する<strong>保証期間</strong>をチェック。イオシスなら3ヶ月保証、じゃんぱらなら1ヶ月保証など、ショップによって異なります。</p><p>保証がないフリマアプリでの購入はリスクが高いため、初心者にはおすすめしません。</p></>,
              },
              {
