...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: 'iMac・Mac miniの寿命は一般的にどのくらいですか？',
    answer:
  ...
  {
    question: 'macOSのサポートが終了したiMac・Mac miniは使い続けても大丈夫？',
    answer:
  ...
  {
    question: '中古のiMac・Mac miniを買うときにサポート期間はどのくらい残っていれば安心？',
    answer:
  ...
  {
    question: 'Mac AirとMac Proで寿命に差はある？',
    answer:
  ...
  {
    question: '古いMacを下取り・売却するベストなタイミングは？',
    answer:
...
export default function MacFaqSection() {
  return (
    <FaqSectionBase
      title="Macの寿命に関するよくある質問"
      description="Macの寿命やサポートに関して、よく寄せられる質問をまとめました。"
      items={FAQ_ITEMS}
    />
  )
}
