...
import { getAllIPhoneModelsIncludingEnded, getAllIPhonePriceLogsByModelIds } from '@/lib/queries'
import ChartEmbed from '../../ChartEmbed'

export const revalidate = 3600
export const metadata: Metadata = { robots: { index: false, follow: false } }

export default async function IPhoneChartEmbedPage({
  searchParams,
}: {
  ...
  return <ChartEmbed series={series} days={days} category="iphone" />
}
