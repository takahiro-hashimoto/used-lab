  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          ただし、セルラーモデルはキャリアのウォッチナンバー契約（月額385円〜）が別途必要です。格安SIM（MVNO）ではウォッチプランに対応していないケースがほとんどのため、利用キャリアの対応状況を事前に確認してください。詳しくは「<Link prefetch={false} href="/watch/gps-cellular-compare/">GPSモデルとセルラーモデルの違い比較</Link>」で解説しています。
        </p>
      </>
    ),
  },
