  ...
  return (
    <div className="m-card m-card--shadow compare-card">
      ...
      <div className="compare-header">
        <div className="compare-header__spacer"></div>
        <div className="compare-header__model">
          ...
          {currentModel.image && (
            <Image
              ...
              style={{ display: 'block', margin: '0.75rem auto 0', objectFit: 'contain' }}
            />
          )}
        </div>
        <div className="compare-header__model">
      ...
      <table className="compare-table">
        ...
        <thead className="visually-hidden">
          <tr>
            <th scope="col">項目</th>
            <th scope="col">{currentModel.model}</th>
            <th scope="col">{compareModel.model}</th>
          </tr>
        </thead>
      ...
      <div className="compare-actions">
        <div className="compare-actions__spacer"></div>
        <div className="compare-actions__btn">
          {iosysUrl ? (
