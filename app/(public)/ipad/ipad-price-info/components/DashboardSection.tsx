    ...
    <section className="l-section" id="pd-dashboard" aria-labelledby="pd-dashboard-title">
      <div className="l-container">
        <h2 className="m-section-heading m-section-heading--lg" id="pd-dashboard-title">
          中古iPadの相場・値段と価格推移グラフ
        </h2>
        <p className="m-section-desc">
          気になるモデルを選択して、価格推移を比較できます。
        </p>
        <p className="m-section-desc">
          機種ごとの違いが知りたい方は「<Link href="/ipad/ipad-spec-table/">歴代iPadスペック比較表</Link>」をご覧ください。
        </p>
        ...
        <p style={{ marginTop: '1rem', fontSize: '0.75rem', color: '#888', lineHeight: 1.7 }}>
          ※ 中古相場は、イオシス・ゲオ・じゃんぱらの3店舗から毎日自動取得した最安値・最高値の平均中間値です。対象は各機種の最小容量モデル（例：iPad Air 第6世代なら128GB）で、100円単位に丸めて表示しています。
        </p>
