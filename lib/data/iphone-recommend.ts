...
export const FAQ_JSONLD_ITEMS = [
  ...
  },
  {
    ...
    answer: `${RECOMMEND_YEAR}年現在、iOSサポートが終了済みまたは終了間近のモデルはセキュリティリスクが高いためおすすめしません。また、バッテリー容量が極端に少ないモデルは日常利用で1日持たないケースが多いです。バッテリー最大容量80%未満の端末も交換費用を含めると割高になる可能性があるため注意が必要です。`,
  },
]
