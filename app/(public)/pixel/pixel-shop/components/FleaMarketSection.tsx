      ...
      <div className="l-container">
        ...
        <div className="m-card m-card--shadow m-card--padded post-check-item">
          ...
          <div className="media-card__desc m-rich-text">
            <p>フリマアプリで中古Google Pixelが安く出品される理由は、以下の構造的な要因によるものです。</p>
        ...
        <div className="m-card m-card--shadow m-card--padded post-check-item">
          ...
          <div className="media-card__desc m-rich-text">
            ...
            <ul className="media-card__list u-mt-md">
              ...
              <li>端末保護機能（Factory Reset Protection）など初期設定トラブル</li>
            </ul>
          </div>
        </div>
        ...
        <div className="l-grid l-grid--2col l-grid--gap-lg u-mt-xl">
          <div className="m-card m-card--shadow recommend-card__fit-box recommend-card__fit-box--good">
            ...
            <ul>
              <li><i className="fa-solid fa-check" aria-hidden="true"></i> 中古Android・Pixelの購入経験がある</li>
          ...
          <div className="m-card m-card--shadow recommend-card__fit-box recommend-card__fit-box--bad">
            ...
            <ul>
              <li><i className="fa-solid fa-xmark" aria-hidden="true"></i> 初めて中古Google Pixelを買う人</li>
