    ...
    <section className="l-section" id="compare" aria-labelledby="heading-compare">
      <div className="l-container">
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg related-links">
          <Link href="/watch/watch-spec-table/" className="m-card m-card--shadow related-link-card">
          ...
          <Link href="/watch/used-watch-support/" className="m-card m-card--shadow related-link-card">
          ...
          <Link href="/watch/used-watch-attention/" className="m-card m-card--shadow related-link-card">
            <span className="related-link-card__icon">
