    ...
    <section className="l-section" id="compare" aria-labelledby="heading-compare">
      <div className="l-container">
        ...
        <div className="l-grid l-grid--3col l-grid--gap-lg related-links">
          ...
          <Link href="/iphone/used-iphone-support/" className="m-card m-card--shadow related-link-card m-card--hoverable">
          ...
          <Link href="/iphone/used-iphone-attention/" className="m-card m-card--shadow related-link-card m-card--hoverable">
            <span className="related-link-card__icon m-icon-box m-icon-box--sm">
