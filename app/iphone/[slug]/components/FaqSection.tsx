...
function buildDisplayFaqs(
  ...
  faqs.push({
    ...
    answer: (
      <>
        <p>
          イオシスがおすすめです。中古スマホの価格が他のサイトに比べて安い場合が多く、お得にiPhoneを購入することができるからです。購入後の保証期間も長く、独自の保証延長サービスがあるのもおすすめのポイント。
        </p>
        {iosysLink && (
          <p>
  ...
  faqs.push({
    ...
    answer: osLife.isSupported ? (
      ...
      <p>
        {model.model}のiOSアップデートサポートは終了している可能性があります。
