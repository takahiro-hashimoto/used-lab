...
import { getPixelVerdict } from '../pixel-helpers'
...
export default function PurchaseVerdict({ model, latestPrice }: Props) {
  ...
  return (
    <ModelPurchaseVerdict
      ...
      description="ベンチマーク性能、Android・セキュリティ更新のサポート寿命、最新相場から導き出した「失敗しないための結論」です。"
      verdict={v}
      topRatings={[
        { icon: 'fa-solid fa-microchip', label: '性能・最新比', value: `${v.performanceRatio}%` },
        { icon: 'fa-solid fa-shield-halved', label: 'サポート残り', value: `残り${v.remainingYears}年` },
